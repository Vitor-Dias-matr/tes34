...
namespace SenacMs.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        {
            var bancoContext = _context.Produto.Include(p => p.Marca).Include(p => p.TipoProduto);
        ...
        public async Task<IActionResult> Create([Bind("Nome,Preco,Quantidade,TipoProdutoId,MarcaId,Id,CriarData,Atualizardata")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nome,Preco,Quantidade,TipoProdutoId,MarcaId,Id,CriarData,Atualizardata")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
